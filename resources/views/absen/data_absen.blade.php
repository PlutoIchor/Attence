...
@section('content')
    ...
    <div class="tabel-data" style="border-color:black">
                        ...
                        <table class="table" style="table-layout : fixed">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" colspan="2"><i class="fa-solid fa-hourglass-start mr-1"></i>Mulai
                                    </th>
                                    <th scope="col" colspan="2"><i class="fa-solid fa-hourglass-end mr-1"></i>Berakhir
                                    </th>
                                    <th scope="col" colspan="2"><i class="fa-solid fa-percent mr-1"></i>Siswa Absen
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
        ...
        @else
            <hr>
            <h3 style="text-align: center; color: gray">-- Tidak ada jadwal untuk hari ini --</h3>
            <hr>
        @endif
    </div>
@endsection
